    ...
    <section className="c-space section-spacing">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
            <p className="headtext">Hi, I'm Michael</p>
            <p className="subtext">
              Over the last 3 years, I developed my frontend and backend dev
              skills to deliver dynamic and responsive software applications.
            </p>
          </div>
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in the DMV area of the United States and am open to
              hybrid/remote work.
            </p>
          </div>
